        ...
        <footer className="text-center pt-10 space-y-8">
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-md mx-auto">
              ...
              {/* Facebook Support */}
              <a href="https://facebook.com/JEFInvestment" target="_blank" rel="noreferrer" className="p-4 bg-surface-card border border-surface-border rounded-2xl flex items-center gap-3 hover:border-blue-500/30 transition-all group">
              ...
              {/* Direct Call */}
              <a href="tel:+265885892269" className="p-4 bg-surface-card border border-surface-border rounded-2xl flex items-center gap-3 hover:border-primary-500/30 transition-all group">
              ...
              {/* Email Support */}
              <a href="mailto:msikaposmw@gmail.com" className="p-4 bg-surface-card border border-surface-border rounded-2xl flex items-center gap-3 hover:border-orange-500/30 transition-all group">
