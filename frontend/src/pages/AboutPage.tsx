        ...
        <footer className="text-center pt-10 space-y-8">
          <div className="space-y-2">
            <p className="text-[10px] font-black text-surface-text/20 tracking-[0.3em]">Technical Support</p>
              {/* WhatsApp Support */}
              <a href="https://wa.me/265993732694" className="w-16 h-16 bg-surface-card border border-surface-border rounded-2xl flex items-center justify-center hover:border-emerald-500/30 transition-all group shadow-sm">
                <div className="w-10 h-10 bg-[#25D366] rounded-xl flex items-center justify-center shadow-lg shadow-emerald-500/20 group-hover:scale-110 transition-transform">
              ...
              {/* Facebook Support */}
              <a href="fb://facewebmodal/f?href=https://www.facebook.com/JEFInvestment" target="_blank" rel="noreferrer" className="w-16 h-16 bg-surface-card border border-surface-border rounded-2xl flex items-center justify-center hover:border-blue-500/30 transition-all group shadow-sm">
                <div className="w-10 h-10 bg-[#1877F2] rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20 group-hover:scale-110 transition-transform">
                  <svg className="w-6 h-6 text-white fill-current" viewBox="0 0 24 24">
              ...
              {/* Direct Call */}
              <a href="tel:+265885892269" className="w-16 h-16 bg-surface-card border border-surface-border rounded-2xl flex items-center justify-center hover:border-primary-500/30 transition-all group shadow-sm">
              ...
              {/* Email Support */}
              <a href="mailto:msikaposmw@gmail.com" className="w-16 h-16 bg-surface-card border border-surface-border rounded-2xl flex items-center justify-center hover:border-orange-500/30 transition-all group shadow-sm">
