        ...
        <div className="w-full bg-surface-bg/80 backdrop-blur-xl border-b border-surface-border relative">
          ...
          >
            <button
              ...
              className={`px-6 py-2 rounded-full text-[9px] font-black tracking-widest transition-all whitespace-nowrap ${selectedCategory === 'All'
            ...
            {CUSTOM_CATEGORIES.map(cat => (
              <button
                ...
                className={`px-6 py-2 rounded-full text-[9px] font-black tracking-widest transition-all whitespace-nowrap ${selectedCategory === cat
                    ? 'bg-primary-500 text-white shadow-md shadow-primary-500/30'
                    : 'bg-surface-card border border-surface-border text-surface-text/40 hover:text-surface-text'
                  }`}
              >
              ...
              {filteredProducts.map(p => (
                ...
                >
                  ...
                  <div className="absolute top-3 md:top-6 left-3 md:left-6 right-3 md:right-6 z-10 flex justify-between items-start pointer-events-none">
                    <div className={`px-3 md:px-5 py-1 md:py-2 rounded-full text-[8px] md:text-[10px] font-black tracking-widest backdrop-blur-md shadow-xl pointer-events-auto border-2 ${p.isService
                    ...
                    <div className="flex flex-col gap-2 pointer-events-auto">
                      <button
                        ...
                        className={`p-2 rounded-full backdrop-blur-md border transition-all ${likedItems.has(p.id)
