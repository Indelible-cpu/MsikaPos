      ...
      <div className="w-full glass-panel border-b border-border/30 transition-colors">
        <div className="w-full px-6 md:px-12 py-6 md:py-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="max-w-xl">
            ...
            <p className="text-[10px] md:text-[14px] font-black text-muted-foreground/60 mt-1 tracking-widest">Premium Products &amp; Services</p>
          </div>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <button 
                          onClick={() => {
                            ...
                            const message = encodeURIComponent(`Hello! I'd like to enquire about *${p.name}* priced at ${priceFormatted}. Is it available?`);
                            window.open(`https://wa.me/${number.replace('+', '')}?text=${message}`, '_blank');
                          }}
                          className="col-span-1 py-3 bg-[#25D366]/10 text-[#25D366] border border-[#25D366]/20 rounded-xl text-[8px] font-black tracking-widest hover:bg-[#25D366] hover:text-white transition-all flex items-center justify-center gap-1.5 btn-press"
                        >
                        ...
                        <button 
                          ...
                          className="col-span-1 py-3 bg-[#25D366]/10 text-[#25D366] border border-[#25D366]/20 rounded-xl hover:bg-[#25D366] hover:text-white transition-all flex items-center justify-center active:scale-95"
                      ...
                      >
                        <span className="flex items-center gap-1.5 text-amber-500">
                          ...
                          <span className="text-[10px] font-black">{p.rating || 1}</span>
                        </span>
            ...
            <div className="p-8 bg-muted/5 border-t border-border/50 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                ...
                <button 
                  ...
                  className="w-full py-5 bg-[#25D366] text-white rounded-2xl text-xs font-black tracking-[0.2em] shadow-xl shadow-[#25D366]/30 hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-2"
                >
