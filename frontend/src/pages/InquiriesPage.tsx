                    ...
                    <div className="flex flex-col justify-center gap-3 lg:w-48 shrink-0">
                      ...
                      <div className="flex items-center gap-2">
                        <button 
                          ...
                          className="w-12 h-12 bg-[#25D366] text-white rounded-xl flex items-center justify-center hover:scale-105 transition-all shadow-lg shadow-emerald-500/20 flex-shrink-0"
                        >
