                    ...
                    <div className="flex flex-col justify-center gap-3 lg:w-48 shrink-0">
                      ...
                      <div className="flex items-center gap-2">
                        <button 
                          ...
                          className="w-12 h-12 bg-[#25D366] md:bg-transparent text-white md:text-[#25D366] rounded-xl flex items-center justify-center hover:scale-105 transition-all shadow-lg shadow-emerald-500/20 md:shadow-none flex-shrink-0"
                        >
                        ...
                        {normalizedStatus !== 'CLOSED' && (
                          <button onClick={() => updateStatus(i.id, 'CLOSED')} className="flex-1 py-3 bg-surface-bg border border-surface-border text-surface-text/60 hover:text-surface-text rounded-xl text-[9px] font-black tracking-widest flex items-center justify-center gap-2 hover:scale-105 transition-all">
