  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'MsikaPos',
        short_name: 'MsikaPos',
        description: 'Modern Cloud POS System — Offline First',
        theme_color: '#09090b',
    ...
    rollupOptions: {
      output: {
        manualChunks(id) {
          ...
          if (id.includes('node_modules/framer-motion') || id.includes('node_modules/lucide-react') || id.includes('node_modules/react-hot-toast')) return 'vendor-ui';
